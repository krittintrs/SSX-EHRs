...
def enc_key_cpabe(padded_key, dub, n):
    ...
    CT_padded_key_name = f'padded_aes_key_20_{dub}_{n}.bin'
...
def main():
    for n in range (0,10):
        key_path = os.path.join(KEY_PATH, f'enc_padded_aes_key_20_{0}_{8}')
        enc_key_cpabe(key_path, 0, n)
